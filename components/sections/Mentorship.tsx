        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{ backgroundColor: "var(--cyan-blue)" }}
                ></div>
              ...
              <div className="flex items-center gap-3">
                <div
                  className="w-2 h-2 rounded-full"
                  style={{ backgroundColor: "var(--middle-gradient)" }}
                ></div>
          ...
          <div className="glass-effect rounded-lg p-8">
            <h3 className="text-2xl font-bold mb-4">
              Why Faith-Based Mentorship?
            </h3>
            <div className="space-y-4 text-muted-foreground">
              <p>
                Learning to code isn&apos;t just about syntax and frameworks.
                It&apos;s about building discipline, patience, and the
                perseverance to solve complex problems
              </p>
              <p>
                In our mentorship program, we integrate authentic Islamic
                values, free from haram and religious innovations, to help you
                become a skilled developer in a way that is most pleasing to
                your Lord
              </p>
              <blockquote>
                &quot;As for those who strive hard in Us (Our Cause), We will
                surely guide them to Our Paths (i.e. Allah&apos;s Religion -
                Islamic Monotheism). And verily, Allah is with the
                Muhsinun (good doers).&quot; (29:69)
              </blockquote>
            </div>
          </div>
        </div>
