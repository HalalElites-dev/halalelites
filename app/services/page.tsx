    ...
    <section id="services" className='bg-background py-24 px-6'>
      <div className='relative max-w-7xl mx-auto'>
        ...
        <div className='relative text-center mb-16'>
          ...
          <h1 className='text-6xl md:text-7xl font-bold mb-8 font-sans'>Services</h1>
          <p className='mt-4 text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed font-mono'>{'// Solutions that honor your values'}</p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-4 flex items-center gap-2">
                <Shield className="h-6 w-6" style={{ color: "var(--brand-cyan)" }} />
                Annual Renewal Costs
              </h3>
              <div className="space-y-3 text-muted-foreground">
                ...
                <p className="text-sm text-muted-foreground mt-4">
                  We can assist with renewals or transfer full control to you for direct payments.
                </p>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-2xl font-bold mb-4">Why Choose Halal Elites?</h3>
              <div className="space-y-3 text-muted-foreground">
                <div className="flex items-start gap-3">
                  <Check className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm">We understand the Muslim community and your specific needs</span>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm">We handle all technical details so you can focus on your business</span>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm">Transparent, affordable pricing with no hidden fees</span>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <span className="text-sm">Risk-free development (pay after completion for standard packages)</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto py-6 justify-items-center'>
          {PRICING_PLANS.map((plan, index) => (
            <div key={index} className='glass-effect rounded-2xl p-8 relative overflow-hidden transition-all duration-300 flex flex-col h-full'>
